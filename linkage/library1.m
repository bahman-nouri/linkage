...
% Last Modified by GUIDE v2.5 28-Sep-2009 13:40:53
...
global type
type=6;
h=imread('l1_type6.png');
image(h);
set(handles.edit1,'string','-45');
set(handles.edit2,'string','20');
set(handles.edit3,'string','30');
set(handles.edit4,'string','4.5');
set(handles.edit5,'visible','off');
set(handles.edit6,'visible','off');
%######
set(handles.text7,'string','Lenght AB');
...
elseif type==2
    m_666(a,motion,time,intervals);
elseif  type==3
    m_649(a,motion,time,intervals);
elseif  type==4
    m_650(a,motion,time,intervals);
elseif type==6
     m_645(a,motion,time,intervals);
end
