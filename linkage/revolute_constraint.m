function [c11,n,s]=revolute_constraint(n)

global numberbeam numbernode_1 numbernode_2
c11='1';
s=0;c=0;
s1=0;
d=findobj('tag',numbernode_1);
x_node1=get(d,'xdata');
y_node1=get(d,'ydata');
 ...
 %-------------------------------------------------------------------
            if rem(k, 2) == 0
                ...
                con1(str2num(n),1)={strcat('x',...
                    num2str(numberbeam),'-'...
                    ,num2str(l1/2),'*cos(t',....
                    num2str(numberbeam),')-','x'...
                    ,num2str(k/2),'-',num2str(l2/2),...
                    '*cos(t',num2str(k/2),')')};
                con1(str2num(n)+1,1)={strcat('y',...
                    num2str(numberbeam),...
                    '-',num2str(l1/2),'*sin(t',...
                    num2str(numberbeam),')-',...
                    'y',num2str(k/2),'-',num2str(l2/2),...
                    '*sin(t',num2str(k/2),')')};
                c11=con1;
                n=str2num(n)+2;
                s=1;
            ...
            if rem(k, 2) ~= 0
                ...
                l2=sqrt((x_node2-x_node4)^2+ (y_node2-y_node4)^2);
                con1(str2num(n)+s1,1)=...
                    {strcat('x',num2str(numberbeam)...
                    ,'-',num2str(l1/2),'*cos(t',...
                    num2str(numberbeam),')-'...
                    ,'x',num2str((k+1)/2),'+',num2str(l2/2),...
                    '*cos(t',num2str((k+1)/2),')')};
                con1(str2num(n)+1+s1,1)={strcat('y',...
                    num2str(numberbeam),...
                    '-',num2str(l1/2),'*sin(t',...
                    num2str(numberbeam),')-',...
                    'y',num2str((k+1)/2),'+',num2str(l2/2),...
                    '*sin(t',num2str((k+1)/2),')')};
                c11=con1;
                n=str2num(n)+2;
                s=1;
